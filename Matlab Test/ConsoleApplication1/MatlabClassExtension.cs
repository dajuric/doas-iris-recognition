...
namespace ConsoleApplication1
{
    ...
    {
        public static void ExecuteWithErrorCheck(this MLAppClass matlab, string command)
        {
            ...
            string message="";
            message = matlab.Execute(command);
            if (message != "")
        ...
        {
            matlab.ExecuteWithErrorCheck("class (" + matrixName + ");");
            ...
            switch (requestedVariableType)
            {
                case "Int32":
                    ...
                    if (varClass != "int32")
                    {
                        matlab.ExecuteWithErrorCheck("int32(" + matrixName + ");");
                        matrixName = "ans";
                    }
                ...
                case "Double":
                    if (varClass != "double")
                    {
                        matlab.ExecuteWithErrorCheck("double(" + matrixName + ");");
                        matrixName = "ans";
                    }
                    matlab.GetWorkspaceData(matrixName, "base", out output);
                    break;
                ...
                case "Boolean":
                    if (varClass != "logical")
                    {
                        matlab.ExecuteWithErrorCheck("logical(" + matrixName + ");");
                        matrixName = "ans";
                    }
                    matlab.GetWorkspaceData(matrixName, "base", out output);
                    break;
