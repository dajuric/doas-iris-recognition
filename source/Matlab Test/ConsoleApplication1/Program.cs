...
namespace ConsoleApplication1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            matlab.Execute("resd=mat1d+mat2d;");
            ...
            Console.Write("Testing Complex matrix operations --> ");
             ...
             matlab.Execute("imageTest=uint8(imageTest)");
             matlab.Execute("Main(imageTest)");
